...
export const PLACEHOLDERS = {
  avatar: generatePlaceholder(100, 100, '👤', '#f3f4f6', '#6b7280'),
  logo: generatePlaceholder(120, 48, 'Logo', '#f3f4f6', '#6b7280'),
  project: generatePlaceholder(400, 250, '🖼️ Project', '#f3f4f6', '#6b7280'),
  about: generatePlaceholder(500, 600, '👨‍💻', '#f3f4f6', '#6b7280'),
  hero: generatePlaceholder(400, 400, '👋', '#f3f4f6', '#6b7280'),
  contact: generatePlaceholder(500, 400, '📧', '#f3f4f6', '#6b7280'),
};
