...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'AI - Chatbot called Vyre, with real-time streaming, full-screen mode, and smooth animations.',
    image: '/assets/images/portfolio/VYRE1.0.png',
    stacks: ['Vue', 'Tailwind CSS', 'Pinecone', 'Langchain', 'Typescript' ],
    githubUrl: 'https://github.com/Anafuwecal/vyre-chatbot',
